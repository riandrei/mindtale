        ...
        <div data-custom-class="body">
            ...
            >
              ...
              >
                ...
                <span style={{ color: "rgb(0, 58, 250)" }}>
                  <bdt className="question">
                    <a
                      href="https://www.mindtale.site"
                      target="_blank"
                      data-custom-class="link"
                    >
                      https://www.mindtale.site
                    </a>
                  </bdt>
                </span>{" "}
          ...
          <div align="center" style={{ textAlign: "left" }}>
            ...
            >
              ...
              >
                ...
                <bdt className="question">riandrei.casanas@gmail.com</bdt>. If
          ...
          <div align="center" style={{ textAlign: "left" }}>
            ...
            >
              ...
              <span style={{ color: "#FFFFFF", fontSize: "11pt" }}>(</span>
              <span style={{ color: "#FFFFFF", fontSize: "14.6667px" }}>3</span>
              <span style={{ color: "#FFFFFF", fontSize: "11pt" }}>
              ...
              >
                ...
                <span style={{ color: "#FFFFFF", fontSize: "11pt" }}>(</span>
                <span style={{ color: "#FFFFFF", fontSize: "14.6667px" }}>
                  4
                </span>
                <span style={{ color: "#FFFFFF", fontSize: "11pt" }}>
          ...
          <div align="center" style={{ textAlign: "left" }}>
            ...
            >
              ...
              the <bdt className="question">Philippines</bdt>
              <bdt className="else-block" />
              <bdt className="statement-end-if-in-editor" />. The language of
