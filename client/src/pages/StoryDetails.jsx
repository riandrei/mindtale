...
export function StoryDetails() {
        ...
        useEffect(() => {
            const handleResize = () => {
                //if pwede, mas maganda kapag 500 - 600 words yung magegenerate ng AI para sa synopsis ng story
            ...
            <div className={styles.Details_top}>
                <div className={ styles.Details_left} >
                    ...
                    <div className={ styles.Details_buttons }>
                        <button><Link to="/LoadingScreen" className={styles.read}>&#9658;<span>Read</span></Link></button>
                        <button>
                            <img src={ Invite } alt="" />
                            Invite
                        </button>
