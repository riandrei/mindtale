...
const StudentDetails = ({handleDotClick, isCount}) => {
    ...
    const handleSubmitClick = (e) => {
        ...
        const {name, birthday, school, sex, gradeLevel, age, bio, fileUpload} = e.target.elements
                ...
                <div className={styles.PersonalDetails_left}>
                    <div className={styles.Top}>
                        <div className={styles.topInner1}>
                            ...
                            <input name="name" id="name" type="text" maxLength={40} value={name} onChange={handleNameChange}/>
                        </div>

                        <div className={styles.topInner2}>
                            <label>Birthdate:</label>
                            <input value={birthday} onChange={handleBirthdayChange} id="birthday" type="date" />
                        </div>
                    </div>

                    <div className={styles.Mid}>
                        <label>School:</label>
                        <select name="" id="school" value={school} onChange={handleSchoolChange}>
                    ...
                    <div className={styles.Bot}>
                        ...
                        <div>
                            ...
                            <select name="" id="gradeLevel" value={gradeLevel} onChange={handleGradeLevelChange}>
                                <option>4</option>
                                <option>5</option>
                                <option>6</option>
                            </select>
                        ...
                        <div>
                            <label>Age:</label>
                            <input type="number" name="" id="age" value={age} onChange={handleAgeChange} />
                        </div>
                    </div>

                    <div className={styles.Textarea}>
                        <label>Tell us about yourself</label>
                        <textarea name="" id="bio" value={bio} onChange={handleBioChange}></textarea>
                    </div>
                    <button type="submit">SUBMIT</button>
                </div>

                <div className={styles.PersonalDetails_right}>
                    <img className={styles.mainIcon} src={mainIcon} alt="Main Icon" width={220} height={220}/>
                    <label htmlFor="fileUpload">Upload custom profile</label>
                    <input className={styles.File} type="file" id="fileUpload" name="image" accept="image/*" onChange={handleFileChange}/>
